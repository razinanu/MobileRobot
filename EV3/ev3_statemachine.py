...
class EV3StateMachine(StateMachine):
    ...
    def __init__(self):
        ...
        self._add_transition(State.APPROACH, State.SEARCH, Transition.FAIL)
        
        self._add_transition(State.EVASION, State.APPROACH, Transition.SUCCESS)
